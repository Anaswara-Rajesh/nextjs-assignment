...
export default function UserCard({ user, onClick }: { user: any; onClick: (user: any) => void }) {
  ...
  return (
    <div
      className="bg-white text-gray-800 rounded-lg shadow-md w-full sm:w-80 mx-auto overflow-hidden transition-transform transform hover:scale-105 hover:shadow-lg hover:shadow-indigo-500/50 cursor-pointer"
